...
const AddExpense = ({ expenseToggle, setExpenseToggle, handleExpenseAmount, updatedExpense }) => {
    ...
    <>
      ...
      {expenseToggle ? (
        ...
        <h2>{updatedExpense ? "Edit Expense" : "Add Expense"}</h2>
          ...
          />
          <button onClick={addExpenses}> {updatedExpense ? "Update Expense" : "Add Expense"}</button>
        </div>
      ) : (
        ""
      )}
